...
namespace Entity.Entities.Worker.Actions
{
    public class BerryGathering : TickActionBehaviour
    {
        ...
        public void Initialize(EntitySpawner spawner, Scriptable.Entities entities, int berryTilePositionX, int berryTilePositionY)
        {
            _spawner = spawner;
            _entities = entities;
        ...
        protected override void OnTick()
        {
            ...
            _spawner.Spawn(_entities.materialsEntities[InteractableTileType.Berry], winner.x, winner.y);
        }
    }
}